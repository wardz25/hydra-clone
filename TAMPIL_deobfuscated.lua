...
-- ════════════════════════════════════════════════════════
local _libEnv=setmetatable({},{__index=getfenv()})
local _libFn=loadstring(game:HttpGet("https://raw.githubusercontent.com/Punpunzero02/updater/refs/heads/main/HydraMainLibrary.lua",true))
setfenv(_libFn,_libEnv)
_libFn()
local HydraLib=_libEnv.VoidUI or _libEnv.HydraLib
assert(type(HydraLib)=="table" and HydraLib.new,"[TAMPIL] HydraMainLibrary failed — VoidUI nil in env")
