...
-- ════════════════════════════════════════════════════════
local _libSrc=game:HttpGet("https://raw.githubusercontent.com/Punpunzero02/updater/refs/heads/main/HydraMainLibrary.lua",true)
local _libChunk=loadstring(_libSrc)
local _libEnv=setmetatable({},{__index=getfenv(0),__newindex=getfenv(0)})
setfenv(_libChunk,_libEnv)()
local HydraLib=_libEnv.VoidUI
assert(type(HydraLib)=="table" and HydraLib.new,"[TAMPIL] HydraMainLibrary failed — VoidUI nil")
