...
-- ════════════════════════════════════════════════════════
-- error handling removed: blocked by Delta executor
-- ════════════════════════════════════════════════════════
...
assert(LocalPlayer,"[TAMPIL] LocalPlayer nil — run script after fully joining the game")
...
pcall(function() LocalPlayer.CharacterAdded:Connect(function(v266) Character=v266 end) end)
...
-- ════════════════════════════════════════════════════════
local HydraLib=loadstring(game:HttpGet("https://raw.githubusercontent.com/Punpunzero02/updater/refs/heads/main/HydraMainLibrary.lua",true))()
assert(type(HydraLib)=="table" and HydraLib.new,"[TAMPIL] HydraMainLibrary failed — nil return")
